export const firestoreTools = {
    definitions: [
        ...
        },
        {
            ...
            function: {
                ...
                description: "Analyze price data to find high and low points for trend lines, support and resistance levels",
                parameters: {
                    type: "object",
                    properties: {
                        symbol: {
                        ...
                        type: {
                            ...
                            description: "Type of points to find (highs for resistance, lows for support)",
                            default: "both",
                        },
                        count: {
                            type: "number",
                            description: "Number of significant points to return (default: 3)",
                            default: 3,
                        },
                    },
    ...
    async getPriceData({ symbol, interval, limit = 100, startTime, endTime, }) {
        try {
            ...
            const change = limitedCandles.length > 1
    ...
    async analyzePricePoints({ symbol, interval, startTime, endTime, type = "both", count = 3, }) {
        try {
            const API_BASE_URL = "https://market.spotcanvas.com";
    ...
    formatResult(toolName, result) {
        switch (toolName) {
            case "get_price_data":
                ...
                return (`Fetched ${result.count} candles for ${result.symbol} (${result.interval}). ` +
                    `Price range: $${result.statistics.low.toFixed(2)} - $${result.statistics.high.toFixed(2)}. ` +
            ...
            case "analyze_price_points":
                ...
                summary += `Price range: $${result.priceRange.lowest.toFixed(2)} - $${result.priceRange.highest.toFixed(2)}`;
                return summary;
            default:
...
//# sourceMappingURL=firestore-tools.js.map